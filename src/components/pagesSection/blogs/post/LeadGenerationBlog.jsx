            ...
            <div className={`${styles.maxWidth} ${styles.paddingX} mx-auto text-white`}>
                ...
                <div className="grid md:flex gap-16">
                    ...
                    <div className="w-full md:w-[70%]">
                        <div>
                            <img src='/images/blog/LEAD-GENRATION-FACEBOOK-TWITTER.jpg' alt="post-images" className="pb-6 w-full" />
                            <p>
                            ...
                            <img src='/images/blog/LEAD GENERATION.svg' alt="post-images" className="py-8 w-full" />
                            ...
                            <img src='./images/blog/LEAD-GENERATION-ON-FACEBOOK.svg' alt="post-images" className="py-8 w-full" />
                            <p>
                            ...
                            <img src={require('../../../../assets/images/blog/FACEBOOK-BLOG-DIGITAL-MARKETING.png')} alt="post-images" className="py-8 w-full" />
                            <p>
