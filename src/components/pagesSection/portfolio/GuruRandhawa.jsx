...
//import PortImg from '../../../assets/images/portfolio/guruRandhawa/BILLBOARD_guruRandhawa_Aghori_Outdoor_shiva_Bhole.jpg'
import { guruRandhawaData } from './PortfolioContents'
const GuruRandhawa = () => {
    return (
        <>
                ...
                {guruRandhawaData.map((guruRandhawa) => (
                    <>
                        ...
                        <div className="w-full mb-20 pt-[110px]">
                            <h1 className="text-5xl mb-[20px]">{guruRandhawa.title}</h1>
